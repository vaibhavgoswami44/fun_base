...
const NewsItem = (props) => {
    ...
    return (
        <>
            <div className="card m-3" style={{ backgroundColor: `${bgColor==='dark'?'black':'white'}`, color: `${textColor==='dark'?'black':'white'}`, boxShadow: bgColor === 'light' ? '1px 1px 10px 1px black' : '1px 1px 10px 1px white' }} >
                ...
                <div className="card-body">
                    <a rel="noreferrer" target='_blank' href={button} style={{ textDecoration: 'none', color: `${textColor==='dark'?'black':'white'}` }} >  <h5 className="card-title" >{title}</h5></a>
                    <a rel="noreferrer" target='_blank' href={button} style={{ textDecoration: 'none', color: `${textColor==='dark'?'black':'white'}` }} >  <p className="card-text"  >{des}</p></a>
